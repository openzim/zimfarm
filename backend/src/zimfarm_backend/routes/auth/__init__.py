...
#
#     orm_user = dbm.User.get(session, username, Unauthorized,
...
#         )
#         self.add_url_rule(
#             "/ssh_authorize", "auth_with_ssh", ssh.asymmetric_key_auth,
# methods = ["POST"]
#         )
#         self.add_url_rule("/test", "test_auth", test, methods=["GET"])
#         self.add_url_rule("/token", "auth_with_token", refresh_token,
# methods=["POST"])
