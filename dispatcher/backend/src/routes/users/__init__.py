...
blueprint.add_url_rule('/<string:user_id>/keys', 'get_ssh_keys', keys.list, methods=['GET'])
blueprint.add_url_rule('/<string:user_id>/keys', 'get_ssh_keys', keys.add, methods=['POST'])
