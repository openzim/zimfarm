...
class RunMWOffliner(Operation):
    ...
    def __init__(self, docker_client: DockerClient, config: {}, task_id: str, working_dir: Path,
    ...
    def execute(self):
        try:
            volumes = {self.working_dir.joinpath(self.task_id).absolute(): {'bind': '/output', 'mode': 'rw'}}
